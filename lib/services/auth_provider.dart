...
class AuthProvider extends ChangeNotifier {
  ...
  TextEditingController emailTextInput = TextEditingController();
  TextEditingController mobileTextInput = TextEditingController();
  TextEditingController usernameTextInput = TextEditingController();
  TextEditingController passworTextInput = TextEditingController();
