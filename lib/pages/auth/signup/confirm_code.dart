      ...
      return Scaffold(
          ...
          body: Container(
            ...
            child: ListView(children: [
              ...
              Text(
                '${provider.emailSignUpPage.text.trim().substring(0, 4)}*******.com',
                ...
                child: ElevatedButton(
                    ...
                    onPressed: provider.isLoading
                      ...
                      if (provider.sendCodeConfController.text
                        ...
                        String? success =
                        await provider.sendEmailConfirmation(provider.emailSignUpPage.text,provider.sendCodeConfController.text);
                        if (success == 'true') {
